 ...
 */
class DeveloperAssetManager extends CAssetManager
{
    ...
    public function init()
    {
        ...
        $this->setDeveloperScripts();

        parent::init();
    }

    private function setDeveloperScripts()
    {
        $url = $this->publish(Yii::getPathOfAlias('application.modules.developer.assets.js'), true);
        Yii::app()->clientScript->registerScriptFile($url . '/developer.js');
    }
